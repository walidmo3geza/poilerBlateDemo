...
export class InvoiceServiceProxy {
  ...
  ): Observable<InvoiceDtoPagedResultDto> {
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<InvoiceDtoPagedResultDto>;
            }
          } else
            return _observableThrow(
              response_
   ...
   * @return Success
   */
  create(body: InvoiceDto | undefined): Observable<InvoiceDto> {
...
@Injectable()
export class ItemsServiceProxy {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
    undefined;
   ...
   * @return Success
   */
  create(body: CreateItemDto | undefined): Observable<ItemDto> {
    let url_ = this.baseUrl + "/api/services/app/Items/Create";
    url_ = url_.replace(/[?&]$/, "");
  ...
  get(id: number | undefined): Observable<ItemDto> {
    let url_ = this.baseUrl + "/api/services/app/Items/Get?";
    if (id === null) throw new Error("The parameter 'id' cannot be null.");
    else if (id !== undefined)
      url_ += "Id=" + encodeURIComponent("" + id) + "&";
    url_ = url_.replace(/[?&]$/, "");
   ...
   * @return Success
   */
  update(body: UpdateItemDto | undefined): Observable<ItemDto> {
    let url_ = this.baseUrl + "/api/services/app/Items/Update";
    url_ = url_.replace(/[?&]$/, "");
   ...
   */
  delete(id: number | undefined): Observable<void> {
    let url_ = this.baseUrl + "/api/services/app/Items/Delete?";
    if (id === null) throw new Error("The parameter 'id' cannot be null.");
    else if (id !== undefined)
      url_ += "Id=" + encodeURIComponent("" + id) + "&";
    url_ = url_.replace(/[?&]$/, "");
  ...
  getAll(
    ...
    skipCount: number | undefined,
    maxResultCount: number | undefined
  ): Observable<ItemDtoPagedResultDto> {
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<ItemDtoPagedResultDto>;
            }
          } else
            return _observableThrow(
              response_
...
export class ItemDtoPagedResultDto implements IItemDtoPagedResultDto {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data["items"])) {
        this.items = [] as any;
        for (let item of _data["items"]) this.items.push(ItemDto.fromJS(item));
      }
      this.totalCount = _data["totalCount"];
    }
  }
